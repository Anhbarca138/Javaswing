        ...
        label.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    out.flush();
                    out.close();
                    JOptionPane.showMessageDialog(new JFrame(), "File của bạn đã được lưu ở " + System.getProperty("user.home") + separator + filename, "Lưu File", JOptionPane.INFORMATION_MESSAGE);
