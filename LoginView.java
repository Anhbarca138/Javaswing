    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if(!server.checkUsername(jTextField1.getText())){
                ...
                JOptionPane.showMessageDialog(new JFrame(),"Tên người dùng này đã được sử dụng","Cảnh báo",JOptionPane.WARNING_MESSAGE);
            }
        } catch (RemoteException ex) {
            JOptionPane.showMessageDialog(this,"Lỗi!! một ngoại lệ remote đã xảy ra trong máy chủ. \\n\\ncố gắng: \\n- Khởi động lại máy chủ \\n- Thay đổi cổng","Cảnh báo",JOptionPane.WARNING_MESSAGE);
            System.out.println("Error: " + ex.getMessage());
        }
